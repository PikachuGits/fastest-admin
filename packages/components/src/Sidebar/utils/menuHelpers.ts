 ...
 * 
 * @param info - 信息数组 [信息键, 徽章值] 或 string[] Information array [info key, badge value] or string[]
 ...
 */
export const parseInfoBadge = (info?: [string, string] | string[]): number | undefined => {
  if (!info || info.length < 2 || !info[1]) return undefined;
