...
import { styled, type DrawerProps, Drawer, Box, IconButton } from "@mui/material";
...
const DefaultDrawer = (props: { trigger: ReactElement<TriggerProps>; children: ReactNode, header?: ReactNode } & DrawerProps) => {
