// packages/hook/src/layout/types.ts
...
/**
 * 布局配置更新函数类型
 * Layout configuration update function type
 */
export type LayoutConfigUpdater = (updates: Partial<LayoutConfig>) => void;

/**
 * 布局配置重置函数类型
 * Layout configuration reset function type
 */
export type LayoutConfigResetter = () => void;

/**
 * 布局配置 Hook 返回值类型
 * Layout configuration hook return type
 */
