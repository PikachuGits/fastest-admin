...
async function getLoadingRawByHtmlTemplate(
  ...
  let templatePathToTry: string | undefined;

  // 1. 用户指定的自定义模板路径
  if (userTemplate) {
    templatePathToTry = isAbsolute(userTemplate)
      ? userTemplate
